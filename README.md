...
Zomcave was started at Ludum Dare 57 in April 2025, but the weekend was mainly spent researching graphic elements, exporting them as SVG files for use in Delphi and creating the level editor. As the level editor was functional at the last minute, game development was not started. It will be launched shortly, and this code repository will be updated accordingly.

In this game, a zombie lives in caves and tries to survive by feeding on what he finds there.

The theme of this game jam was ‘Depths’. To fit in with this idea I went for a dark atmosphere and used the depth of the screen as well as the depths of the earth. To move from one room to another, you use doors that take you away from the player (towards the back of the screen) or bring you closer (towards the front of the screen).

This code repository contains a project developed in Object Pascal language under Delphi. You don't know what Delphi is and where to download it ? You'll learn more [on this web site](https://delphi-resources.developpeur-pascal.fr/).

## Using this video game

Visit [the Zomcave website](https://zomcave.gamolf.fr) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://github.com/DeveloppeurPascal/Zomcave-LudumDare57).
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/Zomcave-LudumDare57) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://zomcave.gamolf.fr) or [the project devlog](https://developpeur-pascal.fr/zomcave.html).
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/Zomcave-LudumDare57/issues) so that I can test and try to correct or provide a workaround.
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/Zomcave-LudumDare57) and [open a new issue](https://github.com/DeveloppeurPascal/Zomcave-LudumDare57/issues).
